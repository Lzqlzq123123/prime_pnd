...
def generate_launch_description():
    ...
    ik_cfg_path = os.path.join(
        adam_mink_path,
        "config/adam_u_vivetracker3_mink_cfg.yaml",
    )
    adam_mink_node = Node(
        package="adam_mink",
        executable="adam_mink_vivetracker3",
        name="adam_mink_vivetracker3",
        output="screen",
        emulate_tty=True,
        parameters=[
    ...
    vive_mocap_node = Node(
        package="vive_mocap",
        executable="vive_mocap",
        name="vive_mocap",
        output="screen",
        emulate_tty=True,
        remappings=[
