...
class AdamMinkVRNode(AdamMinkBase):
    ...
    def init_hand_control(self) -> None:
        ...
        self.joy_btns = dict.fromkeys([JoyBtnIndices.L_X_touch, JoyBtnIndices.R_A_touch], 0)
    ...
    def joy_callback(self, msg: Joy) -> None:
        ...
        for btn in self.joy_btns:
            self.joy_btns[btn] = msg.buttons[btn.value]
        for btn in self.joy_axes:
