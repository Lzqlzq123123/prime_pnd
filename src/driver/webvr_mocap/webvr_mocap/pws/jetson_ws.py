...
try:
    from .common import JETSON_HOST
...
async def check_websocket_service(host: str, port: int, timeout: float = WS_CHECK_TIMEOUT) -> bool:
...
def pws():
    ...
    if app is not None:
        print("启动 Jetson Setup 状态 WebSocket 服务...")
